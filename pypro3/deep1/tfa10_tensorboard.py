# Tensorboard 는 TensorFlow에 기록된 로그를 그래프로 시각화시켜서 보여주는 도구다.
...
tb = TensorBoard(log_dir='.\\my', histogram_freq=1, write_graph=True, write_images=True,
