...
# 대표적인 알고리즘으로 Adaboost(Adaptive Boosting)가 있다. Adaboost는 ensemble-based classifier의 일종으로 weak classifier를 반복적으로 적용해서, data의 특징을 찾아가는 알고리즘이다.
# 최근에는 XGBoost가 인기 있다.
...
from lightgbm import LGBMClassifier # xgboost 보다 연산량이 적고 손실을 줄임. 대용량에 적합
