...
# Pima 인디언 관련 당뇨병 데이터를 보고 당뇨병을 예측하는 분류모델
import pandas
...
print('분류 정확도 : ', model.score(x_train, y_train))   # train으로 정확도 확인    0.7839
pred = model.predict(x_test)
print('분류 정확도 : ', accuracy_score(y_test, pred))    # test으로 정확도 확인    0.7489
