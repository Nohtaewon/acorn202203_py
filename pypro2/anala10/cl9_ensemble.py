...
# 가장 단순한 앙상블 방법으로는 그림 2와 같이 투표를 기반으로 base estimator들을 결합하여 최종 estimator를 만드는 것이다.
# LogisticRegression + DecisionTreeClassifier + KNeighborsClassifier 로 보팅 분류기 생성
# data는 사이킷런의 유방암 진단데이터, breast_cancer를 사용
