...
# 최적화 과정에서 안정성, 수렴 속도를 향상. 과적합/과소적합 방지에도 효과적 ...
...
model = MLPClassifier(hidden_layer_sizes=10, solver='adam', learning_rate_init=0.01, random_state=1)
print(model)
model.fit(x_train, y_train)     # train dataset 으로 모델 학습
...
# 만약 표준화하고 모델을 생성했다면 new_data도 표준화 작업을 해야 함
