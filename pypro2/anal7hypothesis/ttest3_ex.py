...
print(np.mean(man), ' ',np.mean(woman))     # 3.220   3.273
print(stats.shapiro(man).pvalue, ' ', stats.shapiro(woman).pvalue)
# 0.0376255065202713   0.0014988253824412823    정규성 X
...
# 해석 : pvalue=0.0234 < 0.05 귀무가설을 기각함
# 대립가설 채택 : 시험성적의 결과에 따른 학업능력에 변화가 있다.
