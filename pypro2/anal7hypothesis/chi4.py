...
# 귀무 : 교육방법에 따른 교육생들의 만족도 분석에 차이가 없다. 
# 대립 : 교육방법에 따른 교육생들의 만족도 분석에 차이가 있다.
import pandas as pd
...
# 해석 : p-value:1.1679064204212775e-18 < 0.05 귀무가설 기각 대립가설 채택
# 연령대별 sns 서비스별 이용 현황은 동일하지 않다.
