# * 서로 대응인 두 집단(사실 하나의 집단이나 전 후의 관계)의 평균 차이 검정(paired samples t-test)
...
# 귀무 : 복부 수술 전 9명의 몸무게와 복부 수술 후 몸무게 변화는 차이가 없다.
# 대립 : 복부 수술 전 9명의 몸무게와 복부 수술 후 몸무게 변화는 차이가 있다.
...
# 해석 : p-value:0.006 < 0.05 귀무가설 기각
# 대립가설 채택: 복부 수술 전 9명의 몸무게와 복부 수술 후 몸무게 변화는 차이가 있다.
