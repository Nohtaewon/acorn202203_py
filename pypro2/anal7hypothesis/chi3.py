...
# 귀무가설 : 교육 수준과 흡연율 간에 관련이 없다. (독립이다)
# 대립가설 : 교육 수준과 흡연율 간에 관련이 있다. (독립이 아니다)
...
# chi2:18.910915739853955, p-value:0.0008182572832162924, df:4(자유도)
...
# 귀무: 국가전체와 지역에 대한 인종 간 인원수 관련이 없다. (독립적이다)
# 대립: 국가전체와 지역에 대한 인종 간 인원수 관련이 있다. (독립적이지 않다)
...
# 해석 : p-value 0.001180 < 0.05 이므로 귀무가설 기각
# 국가전체와 지역에 대한 인종 간 인원수 관련이 있다. 라는 대립가설을 채택
