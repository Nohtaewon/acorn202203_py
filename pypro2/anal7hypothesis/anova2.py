# 일원분산분석
# 강남구에 있는 GS 편의점 3개 지역 알바생의 급여에 대한 평균에 차이가 있는가 검정하기
...
print(data[:2], type(data))     # <class 'numpy.ndarray'>
...
print('정규성 확인')
print(stats.shapiro(gr1).pvalue)    # 0.333    만족
print(stats.shapiro(gr2).pvalue)    # 0.656
print(stats.shapiro(gr3).pvalue)    # 0.832

print('등분산성 확인')
# print(stats.levene(gr1, gr2, gr3).pvalue)   # 표본의 개수가 적으므로 적당하지 않음
print(stats.bartlett(gr1, gr2, gr3).pvalue)     # 0.3508032 >0.05 만족
...
# f_statistic, p_value : 3.7113359882669763,  0.043589334959178244

# 사후 검정 ( 각 그룹간의 평균의 차이를 구하고 싶다)
